...
class NotificationService {
  ...
  Future<ApiResponse> getNotifications({int page = 1, int perPage = 20}) =>
      _api.get('/notifications/', params: {'page': page, 'per_page': perPage});
  ...
  Future<ApiResponse> getUnreadCount() => _api.get('/notifications/unread-count');
  Future<ApiResponse> getSettings() => _api.get('/notifications/settings');
